...
tracks_no_nulls = FILTER tracks_no_index BY (
  (track_id IS NOT NULL AND track_id != '') AND (artists IS NOT NULL AND artists != '') AND (album_name IS NOT NULL AND album_name != '') AND 
  (track_name IS NOT NULL AND track_name != '') AND
